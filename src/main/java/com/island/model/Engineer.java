...
public class Engineer extends Player {
    private boolean firstShoreUp;

    public Engineer(String name) {
        super(name, PlayerRole.ENGINEER);
        this.firstShoreUp = false;
    }
    ...
    public void setFirstShoreUp(boolean firstShoreUp) {
        this.firstShoreUp = firstShoreUp;
    }
}